...
\coordinate (V3_1) at (0, 1*3);
\coordinate (V1_1) at (0.8660254037844386*3,0.4999999999999999*3);
\coordinate (V4_1) at (-0.8660254037844386*3,0.4999999999999999*3);
\coordinate (V1) at (barycentric cs:V2_1=1,V3_1=1,V1_1=1);
\coordinate (V2) at (barycentric cs:V2_1=1,V3_1=1,V4_1=1);

% Define the coordinates of the vertices
\coordinate (V2_2) at (0-6.5, 0);
\coordinate (V3_2) at (0-6.5, 1*3);
\coordinate (V1_2) at (0.8660254037844386*3-6.5,0.4999999999999999*3);
\coordinate (V4_2) at (-0.8660254037844386*3-6.5,0.4999999999999999*3);
\coordinate (V12) at (barycentric cs:V2_2=1,V3_2=1,V1_2=1);
\coordinate (V22) at (barycentric cs:V2_2=1,V3_2=1,V4_2=1);

\coordinate (V1_3) at (-3.2-1, 0-4);
\coordinate (V2_3) at (-2.2+1, 0-4);
\coordinate (V3_3) at (-2.7, 0.8660*2.5-4);
\coordinate (V4_3) at (-2.7, -0.8660*2.5-4);
\coordinate (V) at (barycentric cs:V2_3=1,V3_3=1,V1_3=1);

% Fill in the faces
\fill[face]  (-1.8,-0.2) -- (-1.8,3.2) --(3,3.2) --(3,-0.2) -- cycle;
\fill[face]  (-1.8-6.5,-0.2) -- (-1.8-6.5,3.2) --(3-6.5,3.2) --(3-6.5,-0.2) -- cycle;
\fill[face]  (-4.4,-1.7) -- (-4.4,-6.3) --(-1,-6.3) --(-1,-1.7) -- cycle;
%\fill[face]  (-1.8-3+1,-0.2-5) -- (-1.8-3+1,3.2-5) --(3-3-1,3.2-5) --(3-3-1,-0.2-5) -- cycle;

%\fill[face]  (-1.8+.5+.5,-0.2-5) -- (-1.8+.5+.5,3.2-5) --(1+.5+.5,3.2-5) --(1+.5+.5,-0.2-5) -- cycle;
%\node[faceLabel] at (barycentric cs:V2=2,V3_1=1,V4_1=1) {$f_3 $};
\node[faceLabel] at (barycentric cs:V3_1=1,V1=1,V2=1) {$ 
$};

%\node[faceLabel] at (barycentric cs:V2_1=1,V4_1=1,V2=2) {$f_2 $};

\node[faceLabel] at (barycentric cs:V2_2=1,V3_2=1,V1_2=1) {$ $};
%\fill[face]  (V2_1) -- (V3_1) -- (V2) -- cycle;
\node[faceLabel] at (barycentric cs:V2_2=1,V3_2=1,V4_2=1) {$ $};



\node[faceLabel] at (3.5-6.,2.1) {\begin{Large}$(\cdot)^{e_i}$\end{Large}};

\node[faceLabel] at (-0.,-1) {\begin{Large}$(\cdot)^{e}$\end{Large}};
%\node[faceLabel] at (-0.4,-.8) {\begin{Large}$(\cdot)^{e'}$\end{Large}};
% Draw the edges
\draw[edge] (V2_1) -- (V1_1);
\draw[edge] (V1_1) --node[edgeLabel] {$e''$}(V3_1);
\draw[edge] (V2) -- node[edgeLabel] {$e_i$} (V1);
%\draw[edge] (V3_1) -- node[edgeLabel] {$e_c$} (V4_1);
%\draw[edge] (V2_1) -- node[edgeLabel] {$e_b$} (V4_1);
\draw[edge] (V2_1) -- node[edgeLabel] {$e$} (V1);
%\draw[edge] (V4_1) -- node[edgeLabel] {$e_3$} (V2);
\draw[edge] (V3_1) --node[edgeLabel] {$e'$}(V2);
\draw[edge] (V2_1) --  (V2);
\draw[edge] (V3_1) -- (V1);
\draw[edge] (V1_1) --  (V1);
...
\draw[edge] (V2_2) -- (V1_2);
\draw[edge] (V1_2) --node[edgeLabel] {$e''$}(V3_2);
\draw[edge] (V3_2) -- node[edgeLabel] {$e_i$} (V2_2);
%\draw[edge] (V3_1) -- node[edgeLabel] {$e_c$} (V4_1);
%\draw[edge] (V2_1) -- node[edgeLabel] {$e_b$} (V4_1);
\draw[edge] (V2_2) -- (V12);
%\draw[edge] (V4_1) -- node[edgeLabel] {$e_3$} (V2);
\draw[edge] (V3_2) --node[edgeLabel] {$e'$}(V22);
\draw[edge] (V2_2) --  (V22);
\draw[edge] (V3_2) -- (V12);
\draw[edge] (V1_2) --  (V12);

\draw[edge] (V3_3) -- node[edgeLabel] {$e''$}(V2_3);
\draw[edge] (V4_3) -- (V2_3);
\draw[edge] (V3_3) -- node[edgeLabel] {$e'$}(V1_3);
\draw[edge] (V1_3) -- (V4_3);
\draw[edge] (V1_3) -- node[edgeLabel] {$e$}(V2_3);

\draw[edge] (V) -- (V2_3);
\draw[edge] (V) -- node[edgeLabel] {$e_i$}(V1_3);
\draw[edge] (V) -- (V3_3);


\draw[edge] (3.3-6.5,1.5) --  (4.5-6.5,1.5);
\draw[edge] (4.5-6.5-0.2,1.7) --  (4.5-6.5,1.5);
\draw[edge] (4.5-6.5-0.2,1.3) --  (4.5-6.5,1.5);
 

\draw[edge] (-0.4,-.5) --  (-1.,-1.5);
\draw[edge] (-1.,-1.5) --  (-1.05,-1.3);
\draw[edge] (-1.,-1.5) --  (-0.8,-1.5); 
 %Draw the vertices
