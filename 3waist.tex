...
\coordinate (V3_1) at (0.5000000000000001, -0.8660254037844386);
...
\coordinate (V9_1) at (1.5, 0.8660254037844388);
\coordinate (V10_1) at (0.9999999999999996, 1.732050807568877);
\coordinate (V9_2) at (1.5, -0.8660254037844388);
\coordinate (V) at (2,0);

% Fill in the faces
\fill[face] (-1.2,1) -- (-1.2,-1) -- (2.2,-1) --(2.2,1)--cycle;
\fill[face]  (V2_1) -- (V7_1) -- (V1_1) -- cycle;
\node[faceLabel] at (barycentric cs:V2_1=1,V7_1=1,V1_1=1) {$F_2$};
\fill[face]  (V1_1) -- (V3_1) -- (V2_1) -- cycle;
\node[faceLabel] at (barycentric cs:V1_1=1,V3_1=1,V2_1=1) {$F_2'$};
\fill[face]  (V1_1) -- (V4_1) -- (V3_1) -- cycle;
%\node[faceLabel] at (barycentric cs:V1_1=1,V4_1=1,V3_1=1) {$3$};
\fill[face]  (V1_1) -- (V5_1) -- (V4_1) -- cycle;
\node[faceLabel] at (barycentric cs:V1_1=1,V5_1=1,V4_1=1) {$F_1'$};
\fill[face]  (V1_1) -- (V6_1) -- (V5_1) -- cycle;
\node[faceLabel] at (barycentric cs:V1_1=1,V6_1=1,V5_1=1) {$F_1$};
\fill[face]  (V1_1) -- (V7_1) -- (V6_1) -- cycle;
%\node[faceLabel] at (barycentric cs:V1_1=1,V7_1=1,V6_1=1) {$6$};
%\fill[face]  (V2_1) -- (V9_1) -- (V7_1) -- cycle;
\node[faceLabel] at (barycentric cs:V2_1=1,V9_1=1,V=1) {$F_3$};
\node[faceLabel] at (barycentric cs:V2_1=1,V9_2=1,V=1) {$F_3'$};
%\fill[face]  (V9_1) -- (V10_1) -- (V7_1) -- cycle;
%\node[faceLabel] at (barycentric cs:V9_1=1,V10_1=1,V7_1=1) {$8$};
%\fill[face]  (V10_1) -- (V8_1) -- (V7_1) -- cycle;
%\node[faceLabel] at (barycentric cs:V10_1=1,V8_1=1,V7_1=1) {$9$};


% Draw the edges
\draw[edge] (V2_1) -- node[edgeLabel] {$e_2$} (V1_1);
\draw[edge] (V3_1) -- (V1_1);
\draw[edge] (V4_1) --  (V1_1);
\draw[edge] (V5_1) -- node[edgeLabel] {$e_1$} (V1_1);
\draw[edge] (V6_1) --  (V1_1);
\draw[edge] (V1_1) --  (V7_1);
\draw[edge] (V2_1) --  (V3_1);
\draw[edge] (V7_1) --  (V2_1);
...
\draw[edge] (V4_1) -- (V5_1);
\draw[edge] (V5_1) --(V6_1);
%\draw[edge] (V6_1) -- node[edgeLabel] {$13$} (V7_1);
%\draw[edge] (V7_1) -- node[edgeLabel] {$14$} (V8_1);
%\draw[edge] (V7_1) -- node[edgeLabel] {$15$} (V9_1);
%\draw[edge] (V7_1) -- node[edgeLabel] {$16$} (V10_1);
%\draw[edge] (V8_1) -- node[edgeLabel] {$17$} (V10_1);
%\draw[edge] (V10_1) -- node[edgeLabel] {$18$} (V9_1);
%\draw[edge] (V3_1) -- node[edgeLabel] {$19$} (V9_2);
\draw[edge] (V2_1) -- (V9_2);
\draw[edge] (V2_1)   -- node[edgeLabel] {$e_3$}(V);
\draw[edge] (V) -- (V9_2);
\draw[edge] (V) -- (V9_1);
% Draw the vertices
