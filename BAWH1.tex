...
\coordinate (V3_1) at (0.9999999999999997, 1.732050807568877);
\coordinate (V4_1) at (1, 0);
\coordinate (V5_1) at (2, 3.33066907387547e-16);
\coordinate (V6_1) at (0.4999999999999999, 0.8660254037844386);
\coordinate (V7_1) at (-0.5, 0.8660254037844384);
\coordinate (V7_2) at (2.5, 0.8660254037844392);
\coordinate (V7_3) at (2, 1.732050807568878);
\coordinate (V7_4) at (-1.110223024625157e-16, 1.732050807568877);
\coordinate (V8_1) at (0.5000000000000001, -0.8660254037844386);
\coordinate (V8_2) at (-0.9999999999999996, -2.220446049250313e-16);
\coordinate (V8_3) at (1.5, -0.8660254037844384);
\coordinate (V8_4) at (3, 8.326672684688674e-16);


% Fill in the faces
\fill[face]  (V4_1) -- (V6_1) -- (V1_1) -- cycle;
\node[faceLabel] at (barycentric cs:V4_1=1,V6_1=1,V1_1=1) {$1$};
\fill[face]  (V1_1) -- (V8_1) -- (V4_1) -- cycle;
\node[faceLabel] at (barycentric cs:V1_1=1,V8_1=1,V4_1=1) {$2$};
\fill[face]  (V6_1) -- (V7_1) -- (V1_1) -- cycle;
\node[faceLabel] at (barycentric cs:V6_1=1,V7_1=1,V1_1=1) {$3$};
\fill[face]  (V7_1) -- (V8_2) -- (V1_1) -- cycle;
\node[faceLabel] at (barycentric cs:V7_1=1,V8_2=1,V1_1=1) {$$};
\fill[face]  (V2_1) -- (V7_3) -- (V3_1) -- cycle;
\node[faceLabel] at (barycentric cs:V2_1=1,V7_3=1,V3_1=1) {$$};
\fill[face]  (V2_1) -- (V3_1) -- (V6_1) -- cycle;
\node[faceLabel] at (barycentric cs:V2_1=1,V3_1=1,V6_1=1) {$$};
\fill[face]  (V4_1) -- (V5_1) -- (V2_1) -- cycle;
\node[faceLabel] at (barycentric cs:V4_1=1,V5_1=1,V2_1=1) {$6$};
\fill[face]  (V4_1) -- (V2_1) -- (V6_1) -- cycle;
\node[faceLabel] at (barycentric cs:V4_1=1,V2_1=1,V6_1=1) {$7$};
\fill[face]  (V5_1) -- (V7_2) -- (V2_1) -- cycle;
\node[faceLabel] at (barycentric cs:V5_1=1,V7_2=1,V2_1=1) {$4$};
\fill[face]  (V3_1) -- (V7_4) -- (V6_1) -- cycle;
\node[faceLabel] at (barycentric cs:V3_1=1,V7_4=1,V6_1=1) {$$};
\fill[face]  (V4_1) -- (V8_3) -- (V5_1) -- cycle;
\node[faceLabel] at (barycentric cs:V4_1=1,V8_3=1,V5_1=1) {$$};
\fill[face]  (V5_1) -- (V8_4) -- (V7_2) -- cycle;
\node[faceLabel] at (barycentric cs:V5_1=1,V8_4=1,V7_2=1) {$$};


% Draw the edges
\draw[edge] (V4_1) -- node {$$} (V1_1);
\draw[edge] (V1_1) -- node {$$} (V6_1);
\draw[edge] (V1_1) -- node {$$} (V7_1);
\draw[edge] (V8_1) -- node {$$} (V1_1);
\draw[edge] (V1_1) -- node {$$} (V8_2);
\draw[edge] (V3_1) -- node {$$} (V2_1);
\draw[edge] (V2_1) -- node[edgeLabel] {$2$} (V4_1);
\draw[edge] (V2_1) -- node {$$} (V5_1);
\draw[edge] (V6_1) -- node {$$} (V2_1);
\draw[edge] (V2_1) -- node {$$} (V7_2);
\draw[edge] (V7_3) -- node {$$} (V2_1);
\draw[edge] (V6_1) -- node {$$} (V3_1);
\draw[edge] (V3_1) -- node {$$} (V7_3);
\draw[edge] (V7_4) -- node {$$} (V3_1);
\draw[edge] (V5_1) -- node {$$} (V4_1);
\draw[edge] (V6_1) -- node[edgeLabel] {$3$} (V4_1);
\draw[edge] (V4_1) -- node {$$} (V8_1);
\draw[edge] (V8_3) -- node {$$} (V4_1);
\draw[edge] (V7_2) -- node {$$} (V5_1);
\draw[edge] (V5_1) -- node {$$} (V8_3);
\draw[edge] (V8_4) -- node {$$} (V5_1);
\draw[edge] (V7_1) -- node {$$} (V6_1);
\draw[edge] (V6_1) -- node {$$} (V7_4);
\draw[edge] (V8_2) -- node {$$} (V7_1);
\draw[edge] (V7_2) -- node {$$} (V8_4);
...
\vertexLabelR{V7_2}{left}{$$}
\vertexLabelR{V7_3}{left}{$$}
\vertexLabelR{V7_4}{left}{$$}
\vertexLabelR{V8_1}{left}{$$}
\vertexLabelR{V8_2}{left}{$$}
\vertexLabelR{V8_3}{left}{$$}
\vertexLabelR{V8_4}{left}{$$}
