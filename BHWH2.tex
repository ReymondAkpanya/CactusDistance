...
\coordinate (V7_2) at (2, 2.775557561562891e-16);
\coordinate (V7_3) at (1.999999999999999, 1.732050807568878);
\coordinate (V7_4) at (-2.220446049250313e-16, 1.732050807568877);
\coordinate (V8_1) at (0.5000000000000001, -0.8660254037844386);
\coordinate (V8_2) at (-0.9999999999999996, -2.220446049250313e-16);
\coordinate (V8_3) at (2.5, -0.8660254037844379);
...
\fill[face]  (V4_1) -- (V7_2) -- (V2_1) -- cycle;
\node[faceLabel] at (barycentric cs:V4_1=1,V7_2=1,V2_1=1) {$4$};
\fill[face]  (V3_1) -- (V7_4) -- (V6_1) -- cycle;
\node[faceLabel] at (barycentric cs:V3_1=1,V7_4=1,V6_1=1) {$$};
\fill[face]  (V4_1) -- (V8_1) -- (V5_1) -- cycle;
\node[faceLabel] at (barycentric cs:V4_1=1,V8_1=1,V5_1=1) {$$};
\fill[face]  (V5_1) -- (V8_3) -- (V7_2) -- cycle;
\node[faceLabel] at (barycentric cs:V5_1=1,V8_3=1,V7_2=1) {$$};
...
\draw[edge] (V5_1) -- node {$$} (V8_1);
\draw[edge] (V8_3) -- node {$$} (V5_1);
\draw[edge] (V7_1) -- node {$$} (V6_1);
\draw[edge] (V6_1) -- node {$$} (V7_4);
\draw[edge] (V8_2) -- node {$$} (V7_1);
\draw[edge] (V7_2) -- node {$$} (V8_3);
