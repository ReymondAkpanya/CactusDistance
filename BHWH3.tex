...
\node[faceLabel] at (barycentric cs:V7_1=1,V8_2=1,V1_1=1) {$4$};
\fill[face]  (V2_1) -- (V7_3) -- (V3_1) -- cycle;
\node[faceLabel] at (barycentric cs:V2_1=1,V7_3=1,V3_1=1) {$5$};
\fill[face]  (V2_1) -- (V3_1) -- (V6_1) -- cycle;
\node[faceLabel] at (barycentric cs:V2_1=1,V3_1=1,V6_1=1) {$6$};
\fill[face]  (V4_1) -- (V5_1) -- (V7_2) -- cycle;
\node[faceLabel] at (barycentric cs:V4_1=1,V5_1=1,V7_2=1) {$7$};
\fill[face]  (V4_1) -- (V2_1) -- (V6_1) -- cycle;
\node[faceLabel] at (barycentric cs:V4_1=1,V2_1=1,V6_1=1) {$8$};
\fill[face]  (V4_1) -- (V7_2) -- (V2_1) -- cycle;
\node[faceLabel] at (barycentric cs:V4_1=1,V7_2=1,V2_1=1) {$9$};
\fill[face]  (V3_1) -- (V7_4) -- (V6_1) -- cycle;
\node[faceLabel] at (barycentric cs:V3_1=1,V7_4=1,V6_1=1) {$10$};
\fill[face]  (V4_1) -- (V8_1) -- (V5_1) -- cycle;
\node[faceLabel] at (barycentric cs:V4_1=1,V8_1=1,V5_1=1) {$11$};
\fill[face]  (V5_1) -- (V8_3) -- (V7_2) -- cycle;
\node[faceLabel] at (barycentric cs:V5_1=1,V8_3=1,V7_2=1) {$12$};


% Draw the edges
\draw[edge] (V4_1) -- node[edgeLabel] {$1$} (V1_1);
...
\draw[edge] (V7_2) -- node[edgeLabel] {$7$} (V4_1);
\draw[edge] (V6_1) -- node[edgeLabel] {$8$} (V2_1);
\draw[edge] (V2_1) -- node[edgeLabel] {$9$} (V7_2);
\draw[edge] (V7_3) -- node[edgeLabel] {$9$} (V2_1);
\draw[edge] (V6_1) -- node[edgeLabel] {$10$} (V3_1);
\draw[edge] (V3_1) -- node[edgeLabel] {$11$} (V7_3);
\draw[edge] (V7_4) -- node[edgeLabel] {$11$} (V3_1);
\draw[edge] (V5_1) -- node[edgeLabel] {$12$} (V4_1);
\draw[edge] (V6_1) -- node[edgeLabel] {$13$} (V4_1);
\draw[edge] (V4_1) -- node[edgeLabel] {$14$} (V8_1);
\draw[edge] (V7_2) -- node[edgeLabel] {$15$} (V5_1);
\draw[edge] (V5_1) -- node[edgeLabel] {$16$} (V8_1);
\draw[edge] (V8_3) -- node[edgeLabel] {$16$} (V5_1);
\draw[edge] (V7_1) -- node[edgeLabel] {$17$} (V6_1);
\draw[edge] (V6_1) -- node[edgeLabel] {$17$} (V7_4);
\draw[edge] (V8_2) -- node[edgeLabel] {$18$} (V7_1);
\draw[edge] (V7_2) -- node[edgeLabel] {$18$} (V8_3);
