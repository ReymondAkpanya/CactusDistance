...
\coordinate (V2_1) at (-0.4999999999999998, -0.8660254037844388);
\coordinate (V2_2) at (2.5, 0.866025403784439);
\coordinate (V3_1) at (1, 0);
\coordinate (V4_1) at (0.5000000000000001, -0.8660254037844386);
\coordinate (V4_2) at (2, 0);
\coordinate (V5_1) at (1.5, 0.8660254037844388);
\coordinate (V6_1) at (0.4999999999999999, 0.8660254037844386);
\coordinate (V6_2) at (-1, 0);
\coordinate (V6_3) at (2, 1.732050807568878);


% Fill in the faces
\fill[face]  (V3_1) -- (V6_1) -- (V1_1) -- cycle;
\node[faceLabel] at (barycentric cs:V3_1=1,V6_1=1,V1_1=1) {$1$};
\fill[face]  (V1_1) -- (V4_1) -- (V3_1) -- cycle;
\node[faceLabel] at (barycentric cs:V1_1=1,V4_1=1,V3_1=1) {$2$};
\fill[face]  (V1_1) -- (V2_1) -- (V4_1) -- cycle;
\node[faceLabel] at (barycentric cs:V1_1=1,V2_1=1,V4_1=1) {$3$};
\fill[face]  (V3_1) -- (V5_1) -- (V6_1) -- cycle;
\node[faceLabel] at (barycentric cs:V3_1=1,V5_1=1,V6_1=1) {$5$};
\fill[face]  (V3_1) -- (V4_2) -- (V5_1) -- cycle;
\node[faceLabel] at (barycentric cs:V3_1=1,V4_2=1,V5_1=1) {$6$};
\fill[face]  (V4_2) -- (V2_2) -- (V5_1) -- cycle;
\node[faceLabel] at (barycentric cs:V4_2=1,V2_2=1,V5_1=1) {$7$};
\fill[face]  (V1_1) -- (V6_2) -- (V2_1) -- cycle;
\node[faceLabel] at (barycentric cs:V1_1=1,V6_2=1,V2_1=1) {$8$};
\fill[face]  (V2_2) -- (V6_3) -- (V5_1) -- cycle;
\node[faceLabel] at (barycentric cs:V2_2=1,V6_3=1,V5_1=1) {$9$};
...
\draw[edge] (V5_1) -- node[edgeLabel] {$4$} (V2_2);
\draw[edge] (V5_1) -- node[edgeLabel] {$5$} (V3_1);
\draw[edge] (V5_1) -- node[edgeLabel] {$6$} (V4_2);
\draw[edge] (V6_1) -- node[edgeLabel] {$7$} (V3_1);
\draw[edge] (V3_1) -- node[edgeLabel] {$8$} (V4_1);
\draw[edge] (V4_2) -- node[edgeLabel] {$8$} (V3_1);
\draw[edge] (V4_1) -- node[edgeLabel] {$9$} (V2_1);
\draw[edge] (V2_2) -- node[edgeLabel] {$9$} (V4_2);
\draw[edge] (V1_1) -- node[edgeLabel] {$10$} (V6_1);
\draw[edge] (V6_2) -- node[edgeLabel] {$10$} (V1_1);
\draw[edge] (V6_1) -- node[edgeLabel] {$11$} (V5_1);
\draw[edge] (V5_1) -- node[edgeLabel] {$11$} (V6_3);
\draw[edge] (V2_1) -- node[edgeLabel] {$12$} (V6_2);
\draw[edge] (V6_3) -- node[edgeLabel] {$12$} (V2_2);
