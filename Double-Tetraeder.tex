...
\coordinate (V4_2) at (-0.5, 0.8660254037844384);
\coordinate (V4_3) at (2, 0);
\coordinate (V4_4) at (0.9999999999999996, 1.732050807568877);
...
\node[faceLabel] at (barycentric cs:V3_1=1,V4_2=1,V1_1=1) {$2$};
\fill[face]  (V1_1) -- (V4_1) -- (V2_1) -- cycle;
\node[faceLabel] at (barycentric cs:V1_1=1,V4_1=1,V2_1=1) {$3$};
\fill[face]  (V2_1) -- (V5_1) -- (V3_1) -- cycle;
\node[faceLabel] at (barycentric cs:V2_1=1,V5_1=1,V3_1=1) {$5$};
\fill[face]  (V5_1) -- (V4_4) -- (V3_1) -- cycle;
\node[faceLabel] at (barycentric cs:V5_1=1,V4_4=1,V3_1=1) {$6$};
\fill[face]  (V2_1) -- (V4_3) -- (V5_1) -- cycle;
\node[faceLabel] at (barycentric cs:V2_1=1,V4_3=1,V5_1=1) {$7$};
...
\draw[edge] (V3_1) -- node[edgeLabel] {$5$} (V5_1);
\draw[edge] (V5_1) -- node[edgeLabel] {$6$} (V4_3);
\draw[edge] (V4_4) -- node[edgeLabel] {$6$} (V5_1);
\draw[edge] (V3_1) -- node[edgeLabel] {$7$} (V2_1);
\draw[edge] (V4_2) -- node[edgeLabel] {$8$} (V3_1);
\draw[edge] (V3_1) -- node[edgeLabel] {$8$} (V4_4);
\draw[edge] (V2_1) -- node[edgeLabel] {$9$} (V4_1);
\draw[edge] (V4_3) -- node[edgeLabel] {$9$} (V2_1);
