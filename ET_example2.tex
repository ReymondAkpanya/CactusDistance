...
\fill[face]  (V4_2) -- (V1_1) -- (V3_1) -- cycle;
\node[faceLabel] at (barycentric cs:V4_2=1,V1_1=1,V3_1=1) {$3$};
\fill[face]  (V2_1) -- (V4_2) -- (V3_1) -- cycle;
\node[faceLabel] at (barycentric cs:V2_1=1,V4_2=1,V3_1=1) {$4$};


% Draw the edges
\draw[edge] (V3_1) -- node[edgeLabel] {$1$} (V4_2);
\draw[edge] (V3_1) -- node[edgeLabel] {$2$} (V1_1);
\draw[edge] (V1_1) -- node[edgeLabel] {$3$} (V4_2);
\draw[edge] (V4_3) -- node[edgeLabel] {$3$} (V1_1);
\draw[edge] (V3_1) -- node[edgeLabel] {$4$} (V2_1);
\draw[edge] (V2_1) -- node[edgeLabel] {$5$} (V4_1);
\draw[edge] (V4_2) -- node[edgeLabel] {$5$} (V2_1);
\draw[edge] (V4_1) -- node[edgeLabel] {$6$} (V3_1);
\draw[edge] (V3_1) -- node[edgeLabel] {$6$} (V4_3);
