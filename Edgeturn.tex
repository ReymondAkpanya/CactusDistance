...
\coordinate (V1_2) at (0, 1.732050807568877);
\coordinate (V2_1) at (1, 0);
\coordinate (V3_1) at (-1, 1.732050807568877);
\coordinate (V4_1) at (-0.5000000000000001, 0.8660254037844386);
\coordinate (V5_1) at (-1, 0);
\coordinate (V6_1) at (-0.4999999999999998, -0.8660254037844388);
\coordinate (V7_1) at (0.5000000000000001, -0.8660254037844386);
\coordinate (V8_1) at (0.4999999999999999, 0.8660254037844386);
\coordinate (V8_2) at (1.5, -0.8660254037844385);
\coordinate (V8_3) at (-1.5, 0.8660254037844384);
\coordinate (V8_4) at (-0.5000000000000007, 2.598076211353316);
\coordinate (V8_5) at (-1.5, -0.866025403784439);
\coordinate (V8_6) at (0, -1.732050807568877);


% Fill in the faces
\fill[face]  (V2_1) -- (V8_1) -- (V1_1) -- cycle;
\node[faceLabel] at (barycentric cs:V2_1=1,V8_1=1,V1_1=1) {$1$};
\fill[face]  (V4_1) -- (V1_2) -- (V3_1) -- cycle;
\node[faceLabel] at (barycentric cs:V4_1=1,V1_2=1,V3_1=1) {$2$};
\fill[face]  (V1_1) -- (V4_1) -- (V5_1) -- cycle;
\node[faceLabel] at (barycentric cs:V1_1=1,V4_1=1,V5_1=1) {$3$};
\fill[face]  (V1_1) -- (V5_1) -- (V6_1) -- cycle;
\node[faceLabel] at (barycentric cs:V1_1=1,V5_1=1,V6_1=1) {$4$};
\fill[face]  (V1_1) -- (V6_1) -- (V7_1) -- cycle;
\node[faceLabel] at (barycentric cs:V1_1=1,V6_1=1,V7_1=1) {$5$};
\fill[face]  (V1_1) -- (V7_1) -- (V2_1) -- cycle;
\node[faceLabel] at (barycentric cs:V1_1=1,V7_1=1,V2_1=1) {$6$};
\fill[face]  (V1_2) -- (V8_4) -- (V3_1) -- cycle;
\node[faceLabel] at (barycentric cs:V1_2=1,V8_4=1,V3_1=1) {$7$};
\fill[face]  (V4_1) -- (V3_1) -- (V8_3) -- cycle;
\node[faceLabel] at (barycentric cs:V4_1=1,V3_1=1,V8_3=1) {$8$};
\fill[face]  (V4_1) -- (V8_3) -- (V5_1) -- cycle;
\node[faceLabel] at (barycentric cs:V4_1=1,V8_3=1,V5_1=1) {$9$};
\fill[face]  (V5_1) -- (V8_5) -- (V6_1) -- cycle;
\node[faceLabel] at (barycentric cs:V5_1=1,V8_5=1,V6_1=1) {$10$};
\fill[face]  (V6_1) -- (V8_6) -- (V7_1) -- cycle;
\node[faceLabel] at (barycentric cs:V6_1=1,V8_6=1,V7_1=1) {$11$};
\fill[face]  (V7_1) -- (V8_2) -- (V2_1) -- cycle;
\node[faceLabel] at (barycentric cs:V7_1=1,V8_2=1,V2_1=1) {$12$};
...
\draw[edge] (V1_2) -- node[edgeLabel] {$3$} (V4_1);
\draw[edge] (V5_1) -- node[edgeLabel] {$4$} (V1_1);
\draw[edge] (V6_1) -- node[edgeLabel] {$5$} (V1_1);
\draw[edge] (V7_1) -- node[edgeLabel] {$6$} (V1_1);
\draw[edge] (V1_1) -- node[edgeLabel] {$7$} (V8_1);
\draw[edge] (V8_4) -- node[edgeLabel] {$7$} (V1_2);
\draw[edge] (V2_1) -- node[edgeLabel] {$8$} (V7_1);
\draw[edge] (V8_1) -- node[edgeLabel] {$9$} (V2_1);
\draw[edge] (V2_1) -- node[edgeLabel] {$9$} (V8_2);
\draw[edge] (V3_1) -- node[edgeLabel] {$10$} (V4_1);
\draw[edge] (V8_3) -- node[edgeLabel] {$11$} (V3_1);
\draw[edge] (V3_1) -- node[edgeLabel] {$11$} (V8_4);
\draw[edge] (V5_1) -- node[edgeLabel] {$12$} (V4_1);
\draw[edge] (V8_3) -- node[edgeLabel] {$13$} (V4_1);
\draw[edge] (V6_1) -- node[edgeLabel] {$14$} (V5_1);
\draw[edge] (V5_1) -- node[edgeLabel] {$15$} (V8_3);
\draw[edge] (V8_5) -- node[edgeLabel] {$15$} (V5_1);
\draw[edge] (V7_1) -- node[edgeLabel] {$16$} (V6_1);
\draw[edge] (V6_1) -- node[edgeLabel] {$17$} (V8_5);
\draw[edge] (V8_6) -- node[edgeLabel] {$17$} (V6_1);
\draw[edge] (V8_2) -- node[edgeLabel] {$18$} (V7_1);
\draw[edge] (V7_1) -- node[edgeLabel] {$18$} (V8_6);
...
\vertexLabelR{V8_5}{left}{$8$}
\vertexLabelR{V8_6}{left}{$8$}
