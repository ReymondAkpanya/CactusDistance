...
\coordinate (V5_1) at (0, 1.732050807568877);
\coordinate (V6_1) at (0.9999999999999996, 1.732050807568877);
\coordinate (V7_1) at (1, 0);
\coordinate (V7_2) at (1.5, 0.866025403784439);
\coordinate (V8_1) at (-0.4999999999999998, -0.8660254037844388);
\coordinate (V8_2) at (1.5, -0.8660254037844385);
\coordinate (V8_3) at (-0.9999999999999996, 0);
\coordinate (V8_4) at (-1, 1.732050807568877);
\coordinate (V8_5) at (0.4999999999999994, 2.598076211353315);
\coordinate (V8_6) at (1.999999999999999, 1.732050807568878);


% Fill in the faces
\fill[face]  (V7_1) -- (V1_1) -- (V3_1) -- cycle;
\node[faceLabel] at (barycentric cs:V7_1=1,V1_1=1,V3_1=1) {$1$};
...
\node[faceLabel] at (barycentric cs:V1_1=1,V7_2=1,V6_1=1) {$5$};
\fill[face]  (V3_1) -- (V2_1) -- (V7_1) -- cycle;
\node[faceLabel] at (barycentric cs:V3_1=1,V2_1=1,V7_1=1) {$6$};
\fill[face]  (V3_1) -- (V8_1) -- (V2_1) -- cycle;
\node[faceLabel] at (barycentric cs:V3_1=1,V8_1=1,V2_1=1) {$7$};
\fill[face]  (V4_1) -- (V8_3) -- (V3_1) -- cycle;
\node[faceLabel] at (barycentric cs:V4_1=1,V8_3=1,V3_1=1) {$8$};
\fill[face]  (V5_1) -- (V8_4) -- (V4_1) -- cycle;
\node[faceLabel] at (barycentric cs:V5_1=1,V8_4=1,V4_1=1) {$9$};
\fill[face]  (V6_1) -- (V8_5) -- (V5_1) -- cycle;
\node[faceLabel] at (barycentric cs:V6_1=1,V8_5=1,V5_1=1) {$10$};
\fill[face]  (V7_2) -- (V8_6) -- (V6_1) -- cycle;
\node[faceLabel] at (barycentric cs:V7_2=1,V8_6=1,V6_1=1) {$11$};
\fill[face]  (V2_1) -- (V8_2) -- (V7_1) -- cycle;
\node[faceLabel] at (barycentric cs:V2_1=1,V8_2=1,V7_1=1) {$12$};
...
\draw[edge] (V1_1) -- node[edgeLabel] {$6$} (V7_1);
\draw[edge] (V7_2) -- node[edgeLabel] {$6$} (V1_1);
...
\draw[edge] (V8_1) -- node[edgeLabel] {$11$} (V3_1);
\draw[edge] (V3_1) -- node[edgeLabel] {$11$} (V8_3);
\draw[edge] (V4_1) -- node[edgeLabel] {$12$} (V5_1);
\draw[edge] (V8_3) -- node[edgeLabel] {$13$} (V4_1);
\draw[edge] (V4_1) -- node[edgeLabel] {$13$} (V8_4);
\draw[edge] (V5_1) -- node[edgeLabel] {$14$} (V6_1);
\draw[edge] (V8_4) -- node[edgeLabel] {$15$} (V5_1);
\draw[edge] (V5_1) -- node[edgeLabel] {$15$} (V8_5);
\draw[edge] (V6_1) -- node[edgeLabel] {$16$} (V7_2);
\draw[edge] (V8_5) -- node[edgeLabel] {$17$} (V6_1);
\draw[edge] (V6_1) -- node[edgeLabel] {$17$} (V8_6);
\draw[edge] (V7_1) -- node[edgeLabel] {$18$} (V8_2);
\draw[edge] (V8_6) -- node[edgeLabel] {$18$} (V7_2);
