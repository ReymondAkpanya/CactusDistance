...
\coordinate (V1_1) at (0, 0.4);
\coordinate (V2_1) at (1, 0.4);
%\coordinate (V3_1) at (0.4999999999999999, 0.8660254037844386);


% Fill in the faces
%\fill[face]  (V2_1) -- (V3_1) -- (V1_1) -- cycle;
\fill[face]  (-0.2,-0.2) -- (1.2,-0.2) -- (1.2,0.4) --(1,0.4) to[bend left=45](0,0.4)-- (-0.2,0.4) -- cycle;
\fill[face]  (-0.2,1) -- (1.2,1) -- (1.2,0.4) --(1,0.4) to[bend right=45](0,0.4)-- (-0.2,0.4) -- cycle;
%\node[faceLabel] at (barycentric cs:V2_1=1,V3_1=1,V1_1=1) {$1$};


% Draw the edges
\draw[edge] (V2_1) to[bend right=45] node[edgeLabel] {$e_1$}(V1_1);
\draw[edge] (V2_1) to[bend left=45] node[edgeLabel] {$e_2$}(V1_1);
