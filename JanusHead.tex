...
\node[faceLabel] at (barycentric cs:V2_1=1,V3_1=1,V4_1=1) {$F_2$};

% Draw the edges
\draw[edge] (V2_1) -- node[edgeLabel] {$e_1$} (V1_1);
\draw[edge] (V1_1) -- node[edgeLabel] {$e_2$} (V3_1);
\draw[edge] (V3_1) -- node[edgeLabel] {$e_3$} (V2_1);
\draw[edge] (V3_1) -- node[edgeLabel] {$e_2$} (V4_1);
\draw[edge] (V2_1) -- node[edgeLabel] {$e_1$} (V4_1);
% Draw the vertices
\vertexLabelR{V1_1}{left}{$V_1$}
\vertexLabelR{V2_1}{left}{$V_2$}
\vertexLabelR{V3_1}{left}{$V_3$}
