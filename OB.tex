...
\node[faceLabel] at (barycentric cs:V2_1=1,V3_1=1,V1_1=1) {$2$};
\fill[face]  (V2_1) -- (V3_1) -- (V4_1) -- cycle;
\node[faceLabel] at (barycentric cs:V2_1=1,V3_1=1,V4_1=1) {$1$};

% Draw the edges
\draw[edge] (V2_1) -- node[edgeLabel] {$3$} (V1_1);
\draw[edge] (V1_1) -- node[edgeLabel] {$4$} (V3_1);
\draw[edge] (V3_1) -- node[edgeLabel] {$1$} (V2_1);
\draw[edge] (V3_1) -- node[edgeLabel] {$2$} (V4_1);
\draw[edge] (V2_1) -- node[edgeLabel] {$3$} (V4_1);
% Draw the vertices
