...
\coordinate (V3_1) at (-0.9999999999999996, 0);
\coordinate (V3_2) at (2, 0);
\coordinate (V4_1) at (-0.5, 0.8660254037844384);
\coordinate (V5_1) at (0.4999999999999999, 0.8660254037844386);
\coordinate (V6_1) at (1.5, 0.8660254037844388);
\coordinate (V6_2) at (-1.5, 0.8660254037844379);
\coordinate (V7_1) at (0.5000000000000001, -0.8660254037844386);
\coordinate (V7_2) at (-0.4999999999999997, -0.8660254037844383);
\coordinate (V7_3) at (1.5, -0.8660254037844386);
\coordinate (V8_1) at (0, 1.732050807568877);
\coordinate (V8_2) at (-1, 1.732050807568876);
\coordinate (V8_3) at (0.9999999999999997, 1.732050807568877);
...
\node[faceLabel] at (barycentric cs:V1_1=1,V7_1=1,V2_1=1) {$2$};
\fill[face]  (V4_1) -- (V3_1) -- (V1_1) -- cycle;
\node[faceLabel] at (barycentric cs:V4_1=1,V3_1=1,V1_1=1) {$3$};
\fill[face]  (V3_1) -- (V7_2) -- (V1_1) -- cycle;
\node[faceLabel] at (barycentric cs:V3_1=1,V7_2=1,V1_1=1) {$4$};
\fill[face]  (V5_1) -- (V4_1) -- (V1_1) -- cycle;
\node[faceLabel] at (barycentric cs:V5_1=1,V4_1=1,V1_1=1) {$5$};
\fill[face]  (V2_1) -- (V3_2) -- (V6_1) -- cycle;
\node[faceLabel] at (barycentric cs:V2_1=1,V3_2=1,V6_1=1) {$6$};
\fill[face]  (V2_1) -- (V7_3) -- (V3_2) -- cycle;
\node[faceLabel] at (barycentric cs:V2_1=1,V7_3=1,V3_2=1) {$7$};
\fill[face]  (V2_1) -- (V6_1) -- (V5_1) -- cycle;
\node[faceLabel] at (barycentric cs:V2_1=1,V6_1=1,V5_1=1) {$8$};
\fill[face]  (V4_1) -- (V6_2) -- (V3_1) -- cycle;
\node[faceLabel] at (barycentric cs:V4_1=1,V6_2=1,V3_1=1) {$9$};
\fill[face]  (V5_1) -- (V8_1) -- (V4_1) -- cycle;
\node[faceLabel] at (barycentric cs:V5_1=1,V8_1=1,V4_1=1) {$10$};
\fill[face]  (V4_1) -- (V8_2) -- (V6_2) -- cycle;
\node[faceLabel] at (barycentric cs:V4_1=1,V8_2=1,V6_2=1) {$11$};
\fill[face]  (V6_1) -- (V8_3) -- (V5_1) -- cycle;
\node[faceLabel] at (barycentric cs:V6_1=1,V8_3=1,V5_1=1) {$12$};
...
\draw[edge] (V7_1) -- node[edgeLabel] {$5$} (V1_1);
\draw[edge] (V1_1) -- node[edgeLabel] {$5$} (V7_2);
\draw[edge] (V3_2) -- node[edgeLabel] {$6$} (V2_1);
\draw[edge] (V5_1) -- node[edgeLabel] {$7$} (V2_1);
\draw[edge] (V6_1) -- node[edgeLabel] {$8$} (V2_1);
\draw[edge] (V2_1) -- node[edgeLabel] {$9$} (V7_1);
\draw[edge] (V7_3) -- node[edgeLabel] {$9$} (V2_1);
\draw[edge] (V3_1) -- node[edgeLabel] {$10$} (V4_1);
\draw[edge] (V6_1) -- node[edgeLabel] {$11$} (V3_2);
\draw[edge] (V3_1) -- node[edgeLabel] {$11$} (V6_2);
\draw[edge] (V7_2) -- node[edgeLabel] {$12$} (V3_1);
\draw[edge] (V3_2) -- node[edgeLabel] {$12$} (V7_3);
\draw[edge] (V4_1) -- node[edgeLabel] {$13$} (V5_1);
\draw[edge] (V6_2) -- node[edgeLabel] {$14$} (V4_1);
\draw[edge] (V4_1) -- node[edgeLabel] {$15$} (V8_1);
\draw[edge] (V8_2) -- node[edgeLabel] {$15$} (V4_1);
\draw[edge] (V5_1) -- node[edgeLabel] {$16$} (V6_1);
\draw[edge] (V8_1) -- node[edgeLabel] {$17$} (V5_1);
\draw[edge] (V5_1) -- node[edgeLabel] {$17$} (V8_3);
\draw[edge] (V6_2) -- node[edgeLabel] {$18$} (V8_2);
\draw[edge] (V8_3) -- node[edgeLabel] {$18$} (V6_1);
