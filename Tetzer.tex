...
\coordinate (V3_1) at (2.5, 0.8660254037844389);
\coordinate (V4_1) at (1, 0);
\coordinate (V5_1) at (2, 0);
\coordinate (V6_1) at (0.4999999999999999, 0.8660254037844386);
\coordinate (V6_2) at (2, 1.732050807568878);
\coordinate (V7_1) at (-0.5, 0.8660254037844384);
\coordinate (V7_2) at (3, 0);
\coordinate (V7_3) at (3, 1.732050807568878);
\coordinate (V8_1) at (0.5000000000000001, -0.8660254037844386);
\coordinate (V8_2) at (-0.9999999999999996, 0);
\coordinate (V8_3) at (1.5, -0.8660254037844386);
\coordinate (V8_4) at (2.5, -0.8660254037844386);
...
\node[faceLabel] at (barycentric cs:V3_1=1,V6_2=1,V2_1=1) {$6$};
...
\node[faceLabel] at (barycentric cs:V5_1=1,V7_2=1,V3_1=1) {$9$};
\fill[face]  (V3_1) -- (V7_3) -- (V6_2) -- cycle;
\node[faceLabel] at (barycentric cs:V3_1=1,V7_3=1,V6_2=1) {$10$};
\fill[face]  (V4_1) -- (V8_3) -- (V5_1) -- cycle;
\node[faceLabel] at (barycentric cs:V4_1=1,V8_3=1,V5_1=1) {$11$};
\fill[face]  (V5_1) -- (V8_4) -- (V7_2) -- cycle;
\node[faceLabel] at (barycentric cs:V5_1=1,V8_4=1,V7_2=1) {$12$};
...
\draw[edge] (V5_1) -- node[edgeLabel] {$16$} (V8_3);
\draw[edge] (V8_4) -- node[edgeLabel] {$16$} (V5_1);
\draw[edge] (V7_1) -- node[edgeLabel] {$17$} (V6_1);
\draw[edge] (V6_2) -- node[edgeLabel] {$17$} (V7_3);
\draw[edge] (V8_2) -- node[edgeLabel] {$18$} (V7_1);
\draw[edge] (V7_2) -- node[edgeLabel] {$18$} (V8_4);
