...
\coordinate (V12_1) at (0.31, 2*0.8660254037844386-0.29);
\coordinate (V13_1) at (0.405, 2*0.8660254037844386-0.29);

\coordinate (V8_3) at (0.5, 0.2);
\coordinate (V9_3) at (0.5,0.5);
\coordinate (V10_3) at (0.35, 0.35);
\coordinate (V11_3) at (0.65, 0.35);
\coordinate (V12_3) at (0.58, 0.295); %%
\coordinate (V13_3) at (0.68, 0.28); %%
...
\coordinate (h51) at (0.95,1.34);
\coordinate (h61) at (0.95,1.26);
...
\coordinate (h52) at (0.05,0.5);
\coordinate (h62) at (0.05,0.42);
...
\coordinate (h53) at (0.,1.+.07);
\coordinate (h63) at (0.-0.07,1.+0.01);

\coordinate (h14) at (0.8,0.732);
\coordinate (h24) at (1.01,0.55);
\coordinate (h34) at (1.0,0.732);
\coordinate (h44) at (0.81,0.53);
\coordinate (h54) at (1.+0.07,0.732+0.0);
\coordinate (h64) at (1.+0.0,0.732-0.07);
...
% Fill in the faces
\fill[face] (2,2) -- (2,-0.3) --(-1,-0.3) -- (-1,2) -- cycle;
...
% Draw the edges
\draw[edge] (V2_1) -- node[edgeLabel] {$e_3$}  (V1_1);
\draw[edge] (V1_1) --   (V3_1);
\draw[edge] (V3_1) --  (V2_1);
\draw[edge] (V4_1) --  node[edgeLabel] {$e_2$} (V2_1);
\draw[edge] (V3_1) --   (V4_1);
\draw[edge] (V3_1) --   (V6_1);
\draw[edge] (V6_1) --  node[edgeLabel] {$e_1$} (V4_1);
\draw[edge] (V3_1) --   (V5_1);
\draw[edge] (V1_1) -- node[edgeLabel] {$e_4$}  (V5_1);
\draw[edge] (V7_1) --   node[edgeLabel] {$e_6$}(V6_1);
\draw[edge] (V7_1) --  node[edgeLabel] {$e_5$} (V5_1);
\draw[edge] (V7_1) --  (V3_1);

\draw[edge=black] (V10_1) --  (V12_1);
\draw[edge=black] (V10_1) --  (V13_1);
%\draw[edge] (V9_1) to[bend left=90]  (V8_1);
%\draw[edge] (V9_1) to[bend right=90]  (V8_1);
\draw[edge=black] (V9_1) to[bend right=40]  (V11_1);
\draw[edge=black] (V8_1) to[bend right=40]  (V10_1);
\draw[edge=black] (V8_1) to[bend left=40]  (V11_1);

\draw[edge=black] (V11_3) --  (V12_3);
\draw[edge=black] (V11_3) --  (V13_3);
%\draw[edge] (V9_1) to[bend left=90]  (V8_1);
%\draw[edge] (V9_1) to[bend right=90]  (V8_1);
\draw[edge=black] (V9_3) to[bend right=40, black]  (V10_3);
\draw[edge=black] (V8_3) to[bend left=40]  (V10_3);
\draw[edge=black] (V8_3) to[bend right=40]  (V11_3);

\draw[edge=black] (h11) to[bend right=40]  (h41);
\draw[edge=black] (h21) to[bend right=40]  (h31);
\draw[edge=black] (h21) to[bend left=40]  (h41);
\draw[edge=black] (h51) to  (h31);
\draw[edge=black] (h61) to  (h31);

%\draw[edge] (h12) to[bend left=40]  (h32);
\draw[edge=black] (h22) to[bend right=40]  (h32);
\draw[edge=black] (h12) to[bend right=40]  (h42);
\draw[edge=black] (h22) to[bend left=40]  (h42);
\draw[edge=black] (h62) to  (h32);
\draw[edge=black] (h52) to  (h32);
%\draw[edge] (h12) to[bend left=40]  (h32);

\draw[edge=black] (h23) to[bend right=40]  (h33);
\draw[edge=black] (h13) to[bend right=40]  (h43);
\draw[edge=black] (h23) to[bend left=40]  (h43);
\draw[edge=black] (h53) to  (h33);
\draw[edge=black] (h63) to  (h33);

\draw[edge=black] (h24) to[bend right=40]  (h34);
\draw[edge=black] (h14) to[bend right=40]  (h44);
\draw[edge=black] (h24) to[bend left=40]  (h44);
\draw[edge=black] (h54) to  (h34);
\draw[edge=black] (h64) to  (h34);
%\draw[edge] (h14) to[bend left=90]  (h24);
% Draw the vertices
\vertexLabelR{V1_1}{left}{$V_4$}
\vertexLabelR{V2_1}{left}{$V_3$}
\vertexLabelR{V3_1}{left}{$V$}
\vertexLabelR{V4_1}{left}{$V_2$}
\vertexLabelR{V5_1}{left}{$V_5$}
\vertexLabelR{V6_1}{left}{$V_1$}
\vertexLabelR{V7_1}{left}{$V_6$}
