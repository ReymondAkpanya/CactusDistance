...
\node[faceLabel] at (barycentric cs:V2_1=1,V4_1=1,V3_1=1) {$F_6$};
\fill[face] (V5_1) -- (V3_1) -- (V1_1) --cycle;
\node[faceLabel] at (barycentric cs:V5_1=1,V3_1=1,V1_1=1) {$F_2$};
\fill[face] (V6_1) -- (V3_1) -- (V4_1) --cycle;
\node[faceLabel] at (barycentric cs:V6_1=1,V7_1=1,V3_1=1) {$F_4$};
\node[faceLabel] at (barycentric cs:V5_1=1,V7_1=1,V3_1=1) {$F_3$};
\node[faceLabel] at (barycentric cs:V6_1=1,V3_1=1,V4_1=1) {$F_5$};

\node[faceLabel] at (barycentric cs:V5_2=1,V5_1=1,V1_1=1) {$F_{10}$};
\node[faceLabel] at (barycentric cs:V5_2=1,V6_2=1,V1_1=1) {$F_9$};
\node[faceLabel] at (barycentric cs:V6_2=1,V2_2=1,V1_1=1) {$F_8$};
\node[faceLabel] at (barycentric cs:V2_1=1,V2_2=1,V1_1=1) {$F_7$};
