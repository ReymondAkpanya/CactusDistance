...
\begin{tikzpicture}[vertexBall, edgeDouble, faceStyle, scale=2.3]
...
%\node[faceLabel] at (barycentric cs:V2_1=1,V4_1=1,V1_1=1) {$F_2$};
% Draw the edges
\draw[edge] (V2_1) -- node[edgeLabel] {$e_1$} (V1_1);
\draw[edge] (V1_1) -- node[edgeLabel] {$e_5$} (V3_1);
\draw[edge] (V3_1) -- node[edgeLabel] {$e_2$} (V2_1);
\draw[edge] (V4_1) -- node[edgeLabel] {$e_3$} (V2_1);
\draw[edge] (V4_1) -- node[edgeLabel] {$e_4$} (V1_1);

%\draw[edge] (V2_2) -- node[edgeLabel] {$e_1$} (V1_2);
\draw[edge] (V1_2) -- node[edgeLabel] {$e_5$} (V3_2);
\draw[edge] (V3_2) -- node[edgeLabel] {$e_2$} (V2_2);
\draw[edge] (V4_2) -- node[edgeLabel] {$e_3$} (V2_2);
\draw[edge] (V4_2) -- node[edgeLabel] {$e_4$} (V1_2);


\draw[edge] (V) -- node[edgeLabel] {$e_5$} (V3_3);
\draw[edge] (V4_3) -- node[edgeLabel] {$e_4$} (V);
\draw[edge] (1.3,0) -- (1.7,0);
\draw[edge] (1.6,-0.1) -- (1.7,0);
\draw[edge] (1.6,0.1) -- (1.7,0);

\draw[edge] (3.3,0) -- (3.7,0);
\draw[edge] (3.6,-0.1) -- (3.7,0);
\draw[edge] (3.6,0.1) -- (3.7,0);
% Draw the vertices
\vertexLabelR{V1_1}{left}{$V_4$}
\vertexLabelR{V2_1}{left}{$V_2$}
\vertexLabelR{V3_1}{left}{$V_1$}
\vertexLabelR{V4_1}{left}{$V_3$}

\vertexLabelR{V1_2}{left}{$V_4$}
\vertexLabelR{V2_2}{left}{$V_2$}
\vertexLabelR{V3_2}{left}{$V_1$}
\vertexLabelR{V4_2}{left}{$V_3$}

\vertexLabelR{V3_3}{left}{$V_1$}
\vertexLabelR{V4_3}{left}{$V_3$}

\vertexLabelR{V}{left}{$V_4$}
\end{tikzpicture}
\end{document}
