...
\coordinate (V4_2) at (1.5, -0.8660254037844386);
% Fill in the faces
\fill[face]  (-0.2,-1) -- (-0.2,0.2) -- (2.2,0.2)--(2.2,-1) -- cycle;

%\fill[face]  (V2_1) -- (V4_1) -- (V1_1) -- cycle;
\node[faceLabel] at (barycentric cs:V2_1=1,V4_1=1,V1_1=1) {$F_1$};
%\fill[face]  (V2_1) -- (V4_2) -- (V3_1) -- cycle;
\node[faceLabel] at (barycentric cs:V2_1=1,V4_2=1,V3_1=1) {$F_2$};

%\fill[face]  (V4_2) -- (V4_1) -- (V1_1) -- cycle;
\node[faceLabel] at (barycentric cs:V4_1=1,V2_1=1,V4_2=1) {$F$};
% Draw the edges
\draw[edge] (V2_1) -- (V1_1);
%\draw[edge] (V1_1) -- node[edgeLabel] {$e_5$} (V3_1);
\draw[edge] (V3_1) --(V2_1);

\draw[edge] (V4_1) -- node[edgeLabel] {$e_1$} (V2_1);
\draw[edge] (V4_1) -- (V1_1);
\draw[edge] (V4_2) -- node[edgeLabel] {$e_2$} (V2_1);
\draw[edge] (V4_2) -- (V3_1);
