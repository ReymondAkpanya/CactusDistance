...
\node[faceLabel] at (barycentric cs:V1_1=1,V6_1=1,V5_1=1) {$F_2$};
% Draw the edges
...
%\draw[edge] (V3_1) -- nod
% Draw the vertices
\vertexLabelR{V1_1}{left}{$V$}
\vertexLabelR{V2_1}{left}{$V_2$}
