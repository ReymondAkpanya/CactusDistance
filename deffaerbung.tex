...
\coordinate (V4_1) at (-0.8660254037844388,0.5);

\coordinate (V2_2) at (2.5, 0);
\coordinate (V3_2) at (2.5, 1);
\coordinate (V1_2) at (2.8660254037844386+0.5,0.5);
\coordinate (V4_2) at (-0.8660254037844388+2.5,0.5);

% Fill in the faces
\fill[face]  (-1,1.2) -- (1,1.2) -- (1,-0.2)--(-1,-0.2) -- cycle;
\fill[face]  (1.5,1.2) -- (3.5,1.2) -- (3.5,-0.2)--(1.5,-0.2) -- cycle;
\fill[face]  (V2_1) -- (V3_1) -- (V1_1) -- cycle;
\node[faceLabel] at (barycentric cs:V2_1=1,V3_1=1,V1_1=1) {$F'$};
\fill[face]  (V2_1) -- (V4_1) -- (V3_1) -- cycle;
\node[faceLabel] at (barycentric cs:V2_1=1,V4_1=1,V3_1=1) {$F$};

\fill[face]  (V2_2) -- (V3_2) -- (V1_2) -- cycle;
\node[faceLabel] at (barycentric cs:V2_2=1,V3_2=1,V1_2=1) {$F'$};
\fill[face]  (V2_2) -- (V4_2) -- (V3_2) -- cycle;
\node[faceLabel] at (barycentric cs:V2_2=1,V4_2=1,V3_2=1) {$F$};
\node[faceLabel] at (0,-0.5) {$Typ\, m$};
\node[faceLabel] at (2.5,-0.5) {$Typ\, r$};
% Draw the edges
\draw[edge=blue] (V2_1) -- (V1_1);
\draw[edge=green] (V1_1) -- (V3_1);
\draw[edge=red] (V3_1) -- node[edgeLabel] {$e$} (V2_1);
\draw[edge=blue] (V4_1) --  (V2_1);
\draw[edge=green] (V3_1) --  (V4_1);

\draw[edge=blue] (V2_2) --  (V1_2);
\draw[edge=green] (V1_2) --  (V3_2);
\draw[edge=red] (V3_2) -- node[edgeLabel] {$e$} (V2_2);
\draw[edge=green] (V4_2) --  (V2_2);
\draw[edge=blue] (V3_2) --  (V4_2);
% Draw the vertices
