...
\coordinate (V2_1) at (0, -2);
\coordinate (V3_1) at (-2,0);
\coordinate (V4_1) at (0,2);
\coordinate (V5_1) at (1, 0);
\coordinate (V6_1) at (0, -1);
\coordinate (V7_1) at (-1,0);
\coordinate (V8_1) at (0,1);

\coordinate (V1_2) at (2+5, 0);
\coordinate (V2_2) at (0+5, -2);
\coordinate (V3_2) at (-2+5,0);
\coordinate (V4_2) at (5,2);
\coordinate (V5_2) at (1+5, 0);
\coordinate (V6_2) at (0+5, -1);
\coordinate (V7_2) at (-1+5,0);
\coordinate (V8_2) at (0+5,1);
% Fill in the faces
...
% Draw the vertices
\vertexLabelR{V1_1}{left}{$1_X$}
\vertexLabelR{V2_1}{left}{$2_X$}
\vertexLabelR{V3_1}{left}{$3_X$}
\vertexLabelR{V4_1}{left}{$4_X$}
\vertexLabelR{V5_1}{left}{$5_X$}
\vertexLabelR{V6_1}{left}{$6_X$}
\vertexLabelR{V7_1}{left}{$7_X$}
\vertexLabelR{V8_1}{left}{$8_X$}
\vertexLabelR{V1_2}{left}{$3_Y$}
\vertexLabelR{V2_2}{left}{$2_Y$}
\vertexLabelR{V3_2}{left}{$1_Y$}
\vertexLabelR{V4_2}{left}{$4_Y$}
\vertexLabelR{V5_2}{left}{$7_Y$}
\vertexLabelR{V6_2}{left}{$6_Y$}
\vertexLabelR{V7_2}{left}{$5_Y$}
\vertexLabelR{V8_2}{left}{$8_Y$}
