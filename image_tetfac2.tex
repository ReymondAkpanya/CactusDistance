...
\coordinate (V) at (barycentric cs:V2_1=1,V3_1=1,V1_1=1);

% Fill in the faces
\fill[face] (-0.7,-1)--(-0.7,1.1)--(1.7,1.1)--(1.7,-1)--cycle;
\fill[face]  (V2_1) -- (V3_1) -- (V1_1) -- cycle;
\node[faceLabel] at (barycentric cs:V2_1=1,V3_1=1,V1_1=1) {$i$};
\fill[face]  (V1_1) -- (V6_1) -- (V2_1) -- cycle;
\node[faceLabel] at (barycentric cs:V1_1=1,V6_1=1,V2_1=1) {$k$};
\fill[face]  (V3_1) -- (V4_1) -- (V1_1) -- cycle;
\node[faceLabel] at (barycentric cs:V3_1=1,V4_1=1,V1_1=1) {$j$};
\fill[face]  (V2_1) -- (V5_1) -- (V3_1) -- cycle;
\node[faceLabel] at (barycentric cs:V2_1=1,V5_1=1,V3_1=1) {$l$};
\fill[face]  (V) -- (V2_1) -- (V3_1) -- cycle;
\node[faceLabel] at (barycentric cs:V2_1=1,V=1,V3_1=1) {$i_3$};
\fill[face]  (V) -- (V1_1) -- (V3_1) -- cycle;
\node[faceLabel] at (barycentric cs:V1_1=1,V=1,V3_1=1) {$i_1$};
\fill[face]  (V) -- (V1_1) -- (V2_1) -- cycle;
\node[faceLabel] at (barycentric cs:V1_1=1,V=1,V2_1=1) {$i_2$};
% Draw the edges
\draw[edge] (V2_1) -- (V1_1);
\draw[edge] (V1_1) -- (V3_1);
\draw[edge] (V1_1) -- (V4_1);
