...
\coordinate (V1) at (-0.2,-1.06);
\coordinate (V2) at (-0.2,1.06);
\coordinate (V3) at (1.2,1.06);
\coordinate (V4) at (1.2,-1.06);
% Fill in the faces
\fill[face]  (V1) -- (V2) -- (V3)-- (V4) -- cycle;
\fill[face]  (V4) -- (V2) -- (V3) -- cycle;
\fill[face]  (V3_1) -- (V4_1) -- (V2_1) --  cycle;
\node[faceLabel] at (barycentric cs:V3_1=1,V4_1=1,V2_1=1) {$F_1$};
\node[faceLabel] at (barycentric cs:V3_1=1,V5_1=1,V2_1=1) {$F_2$};
...
% Draw the edges
%\draw[edge=green] (V1_1) -- (V2_1);
%\draw[edge=blue] (V3_1) --  (V1_1);
%\draw[edge=red] (V1_1) -- (V4_2);
%\draw[edge=red] (V4_3) -- (V1_1);
\draw[edge] (V3_1) --  (V2_1);
\draw[edge] (V2_1) --  (V4_1);
\draw[edge] (V4_1) --(V3_1);
\draw[edge] (V5_1) --(V3_1);
\draw[edge] (V5_1) -- (V2_1);
%\draw[edge=green] (V4_1) -- (V3_1);
%\draw[edge=green] (V3_1) -- (V4_3);
