...
\fill[face=green,opacity=0.4]  (V2_1) -- (V4_1) -- (V3_1) -- cycle;
\node[faceLabel] at (barycentric cs:V2_1=1,V4_1=1,V3_1=1) {$ $};
\fill[face=green,opacity=0.4]  (V2_1) -- (V5_1) -- (V4_1) -- cycle;
\node[faceLabel] at (barycentric cs:V2_1=1,V5_1=1,V4_1=1) {$ $};
\fill[face=green,opacity=0.4]  (V5_1) -- (V6_1) -- (V4_1) -- cycle;
...
\draw[edge] (V3_1) --  (V2_1);
\draw[edge] (V4_1) --  (V2_1);
\draw[edge] (V5_1) --  node[edgeLabel] {$e_2'$}(V2_1);
\draw[edge] (V3_1) --  node[edgeLabel] {$e_1$}(V4_1);
\draw[edge] (V4_1) --  (V5_1);
\draw[edge] (V4_1) --   node[edgeLabel] {$e_2$}(V6_1);
\draw[edge] (V6_1) --  (V5_1);
\draw[edge] (V8_1) --   node[edgeLabel] {$e_3'$}(V5_1);
\draw[edge] (V6_1) --   node[edgeLabel] {$e_3$}(V7_1);
\draw[edge] (V6_1) --  (V8_1);
\draw[edge] (V7_1) -- node[edgeLabel] {$e'$} (V8_1);
...
\vertexLabelR{V2}{left}{${V}'$}
\vertexLabelR{V3_2}{left}{$V_2$}
\vertexLabelR{V4_2}{left}{$V_2$}
\vertexLabelR{V6_2}{left}{$V_2$}
\vertexLabelR{V7_2}{left}{$V_2$}
\vertexLabelR{V11}{left}{$V_2$}
\vertexLabelR{V12}{left}{$V_1$}
\vertexLabelR{V34}{left}{$V_1$}
\vertexLabelR{V46}{left}{$V_1$}
\vertexLabelR{V67}{left}{$V_1$}
\vertexLabelR{V72}{left}{$V_1$}
