...
\coordinate (V4_2) at (3.5, 0.8660254037844388);

% Fill in the faces
\fill[face]  (V1_1) -- (V3_1) --(V4_2)-- (V2_2) -- cycle;
...
\node[faceLabel] at (barycentric cs:V2_2=1,V3_2=1,V1_2=1) {$5$};
\fill[face]  (V2_2) -- (V4_2) -- (V3_2) -- cycle;
\node[faceLabel] at (barycentric cs:V2_2=1,V4_2=1,V3_2=1) {$6$};

\node[faceLabel] at (barycentric cs:V2_1=1,V4_1=1,V1_2=1) {$3$};
\node[faceLabel] at (barycentric cs:V1_2=1,V4_1=1,V3_2=1) {$4$};
% Draw the edges
\draw[edge] (V2_1) -- (V1_1);
\draw[edge] (V1_1) -- (V3_1);
\draw[edge] (V3_1) -- (V2_1);
...
\vertexLabelR{V1_2}{left}{$5$}
\vertexLabelR{V2_2}{left}{$6$}
\vertexLabelR{V3_2}{left}{$7$}
\vertexLabelR{V4_2}{left}{$8$}
\end{tikzpicture}
\end{document}
