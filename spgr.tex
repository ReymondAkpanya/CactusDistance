...
\coordinate (h14) at (0.8+0.2,0.732+0.2);
\coordinate (h24) at (1.01+0.2,0.55+0.2);
\coordinate (h34) at (1.0+0.2,0.732+0.2);
\coordinate (h44) at (0.81+0.2,0.53+0.2);
\coordinate (h54) at (0.81+0.25,0.53+0.25);
\coordinate (h64) at (0.81+0.04+0.2,0.53-0.07+0.2);
\coordinate (a) at (0.89,.82);
\coordinate (b) at (-0.3,.82);
\coordinate (a1) at (0.7,.82);
\coordinate (b1) at (-0.1,.82);
...
\node[faceLabel] at (a) {$1_11_2$};
\node[faceLabel] at (b) {$(4)^2$};
