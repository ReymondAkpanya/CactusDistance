...
\node[faceLabel] at (barycentric cs:V2_1=1,V5_1=1,V4_1=1) {$3$};
\fill[face]  (V5_1) -- (V6_1) -- (V4_1) -- cycle;
\node[faceLabel] at (barycentric cs:V5_1=1,V6_1=1,V4_1=1) {$4$};
\fill[face]  (V8_1) -- (V7_1) -- (V6_1) -- cycle;
\node[faceLabel] at (barycentric cs:V8_1=1,V7_1=1,V6_1=1) {$5$};
\fill[face]  (V5_1) -- (V8_1) -- (V6_1) -- cycle;
\node[faceLabel] at (barycentric cs:V5_1=1,V8_1=1,V6_1=1) {$6$};
