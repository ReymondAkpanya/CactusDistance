...
\coordinate (V5_1) at (-0.9999999999999996, 0);
\coordinate (V6_1) at (-0.4999999999999997, -0.8660254037844383);
...
\coordinate (V10_1) at (-1.5, 0.8660254037844379);
\coordinate (V11_1) at (-1.499999999999999, -0.8660254037844384);


% Fill in the faces
\fill[face] (2,2) -- (2,-1.5) --(-2,-1.5) -- (-2,2) -- cycle;
\fill[face]  (V2_1) -- (V3_1) -- (V1_1) -- cycle;
\node[faceLabel] at (barycentric cs:V2_1=1,V3_1=1,V1_1=1) {$F_1$};
\fill[face]  (V3_1) -- (V4_1) -- (V1_1) -- cycle;
\node[faceLabel] at (barycentric cs:V3_1=1,V4_1=1,V1_1=1) {$F_2$};
\fill[face]  (V4_1) -- (V5_1) -- (V1_1) -- cycle;
\node[faceLabel] at (barycentric cs:V4_1=1,V5_1=1,V1_1=1) {$F_3$};
\fill[face]  (V5_1) -- (V6_1) -- (V1_1) -- cycle;
\node[faceLabel] at (barycentric cs:V5_1=1,V6_1=1,V1_1=1) {$F_4$};
\fill[face]  (V6_1) -- (V7_1) -- (V1_1) -- cycle;
\node[faceLabel] at (barycentric cs:V6_1=1,V7_1=1,V1_1=1) {$F_5$};
\fill[face]  (V1_1) -- (V7_1) -- (V2_1) -- cycle;
\node[faceLabel] at (barycentric cs:V1_1=1,V7_1=1,V2_1=1) {$F_6$};
\fill[face]  (V2_1) -- (V8_1) -- (V3_1) -- cycle;
\node[faceLabel] at (barycentric cs:V2_1=1,V8_1=1,V3_1=1) {$F_a$};
\fill[face]  (V3_1) -- (V9_1) -- (V4_1) -- cycle;
\node[faceLabel] at (barycentric cs:V3_1=1,V9_1=1,V4_1=1) {$F_h$};
\fill[face]  (V4_1) -- (V10_1) -- (V5_1) -- cycle;
\node[faceLabel] at (barycentric cs:V4_1=1,V10_1=1,V5_1=1) {$F_d$};
\fill[face]  (V5_1) -- (V11_1) -- (V6_1) -- cycle;
\node[faceLabel] at (barycentric cs:V5_1=1,V11_1=1,V6_1=1) {$F_e$};
...
\draw[edge] (V5_1) --  (V4_1);
\draw[edge] (V4_1) --  (V9_1);
\draw[edge] (V10_1) --  (V4_1);
\draw[edge] (V6_1) --  (V5_1);
\draw[edge] (V5_1) --  (V10_1);
\draw[edge] (V11_1) --  (V5_1);
\draw[edge] (V7_1) --  (V6_1);
\draw[edge] (V6_1) --  (V11_1);
