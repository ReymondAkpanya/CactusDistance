...
\coordinate (V2_1) at (2, 3.885780586188048e-16);
\coordinate (V3_1) at (1.5, 0.8660254037844388);
\coordinate (V4_1) at (1.5, -0.8660254037844384);
\coordinate (V5_1) at (1, 0);
\coordinate (V6_1) at (-0.5, 0.8660254037844384);
\coordinate (V6_2) at (2.5, 0.8660254037844393);
\coordinate (V6_3) at (2.5, -0.8660254037844377);
\coordinate (V7_1) at (0.4999999999999999, 0.8660254037844386);
\coordinate (V7_2) at (1.999999999999999, 1.732050807568877);
\coordinate (V8_1) at (0.5000000000000001, -0.8660254037844386);
\coordinate (V8_2) at (-0.9999999999999996, -2.220446049250313e-16);
\coordinate (V8_3) at (2.000000000000001, -1.732050807568877);
...
\node[faceLabel] at (barycentric cs:V6_1=1,V8_2=1,V1_1=1) {$$};
\fill[face]  (V5_1) -- (V2_1) -- (V3_1) -- cycle;
\node[faceLabel] at (barycentric cs:V5_1=1,V2_1=1,V3_1=1) {$$};
\fill[face]  (V2_1) -- (V6_2) -- (V3_1) -- cycle;
\node[faceLabel] at (barycentric cs:V2_1=1,V6_2=1,V3_1=1) {$$};
\fill[face]  (V5_1) -- (V4_1) -- (V2_1) -- cycle;
\node[faceLabel] at (barycentric cs:V5_1=1,V4_1=1,V2_1=1) {$$};
\fill[face]  (V4_1) -- (V6_3) -- (V2_1) -- cycle;
\node[faceLabel] at (barycentric cs:V4_1=1,V6_3=1,V2_1=1) {$$};
\fill[face]  (V5_1) -- (V3_1) -- (V7_1) -- cycle;
\node[faceLabel] at (barycentric cs:V5_1=1,V3_1=1,V7_1=1) {$4$};
\fill[face]  (V6_2) -- (V7_2) -- (V3_1) -- cycle;
\node[faceLabel] at (barycentric cs:V6_2=1,V7_2=1,V3_1=1) {$$};
\fill[face]  (V5_1) -- (V8_1) -- (V4_1) -- cycle;
\node[faceLabel] at (barycentric cs:V5_1=1,V8_1=1,V4_1=1) {$$};
\fill[face]  (V4_1) -- (V8_3) -- (V6_3) -- cycle;
\node[faceLabel] at (barycentric cs:V4_1=1,V8_3=1,V6_3=1) {$$};


% Draw the edges
\draw[edge] (V5_1) -- node {$$} (V1_1);
...
\draw[edge] (V6_2) -- node {$$} (V2_1);
\draw[edge] (V2_1) -- node {$$} (V6_3);
\draw[edge] (V3_1) -- node {$$} (V5_1);
\draw[edge] (V3_1) -- node {$$} (V6_2);
\draw[edge] (V7_1) -- node {$$} (V3_1);
\draw[edge] (V3_1) -- node {$$} (V7_2);
\draw[edge] (V4_1) -- node {$$} (V5_1);
\draw[edge] (V6_3) -- node {$$} (V4_1);
\draw[edge] (V4_1) -- node {$$} (V8_1);
\draw[edge] (V8_3) -- node {$$} (V4_1);
\draw[edge] (V7_1) -- node {$$} (V5_1);
\draw[edge] (V5_1) -- node {$$} (V8_1);
\draw[edge] (V6_1) -- node {$$} (V7_1);
\draw[edge] (V7_2) -- node {$$} (V6_2);
\draw[edge] (V8_2) -- node {$$} (V6_1);
\draw[edge] (V6_3) -- node {$$} (V8_3);
