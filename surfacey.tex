...
\coordinate (V3_1) at (2.5, 0.8660254037844392);
\coordinate (V4_1) at (1, 0);
\coordinate (V5_1) at (2, 3.33066907387547e-16);
\coordinate (V6_1) at (0.4999999999999999, 0.8660254037844386);
\coordinate (V6_2) at (1.999999999999999, 1.732050807568877);
\coordinate (V7_1) at (-0.5, 0.8660254037844384);
\coordinate (V7_2) at (3, 9.436895709313831e-16);
\coordinate (V7_3) at (2.999999999999999, 1.732050807568878);
...
\coordinate (V8_4) at (2.5, -0.8660254037844379);
...
\fill[face]  (V5_1) -- (V3_1) -- (V2_1) -- cycle;
\node[faceLabel] at (barycentric cs:V5_1=1,V3_1=1,V2_1=1) {$5$};
\fill[face]  (V3_1) -- (V6_2) -- (V2_1) -- cycle;
\node[faceLabel] at (barycentric cs:V3_1=1,V6_2=1,V2_1=1) {$$};
...
\fill[face]  (V5_1) -- (V7_2) -- (V3_1) -- cycle;
\node[faceLabel] at (barycentric cs:V5_1=1,V7_2=1,V3_1=1) {$4$};
\fill[face]  (V3_1) -- (V7_3) -- (V6_2) -- cycle;
\node[faceLabel] at (barycentric cs:V3_1=1,V7_3=1,V6_2=1) {$$};
...
\draw[edge] (V2_1) -- node {$$} (V3_1);
\draw[edge] (V2_1) -- node {$$} (V4_1);
\draw[edge] (V2_1) -- node {$$} (V5_1);
\draw[edge] (V6_1) -- node {$$} (V2_1);
\draw[edge] (V2_1) -- node {$$} (V6_2);
\draw[edge] (V3_1) -- node {$$} (V5_1);
\draw[edge] (V6_2) -- node {$$} (V3_1);
\draw[edge] (V3_1) -- node {$$} (V7_2);
\draw[edge] (V7_3) -- node {$$} (V3_1);
