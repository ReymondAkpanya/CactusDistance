...
% Fill in the faces
\fill[face]  (1*3,-0.2) -- (1*3,1*3+0.2) -- (-1*3,1*3+0.2)--(-1*3,-0.2) -- cycle;
\fill[face]  (V2_1) -- (V3_1) -- (V1_1) -- cycle;
\node[faceLabel] at (barycentric cs:V2_1=1,V3_1=1,V1_1=1) {$ $};
\fill[face]  (V2_1) -- (V3_1) -- (V4_1) -- cycle;
\node[faceLabel] at (barycentric cs:V2_1=1,V3_1=1,V4_1=1) {$ $};
...
\node[faceLabel] at (barycentric cs:V3_1=1,V2_1=1,V2=2) {$f_1
$};

\node[faceLabel] at (barycentric cs:V2_1=1,V4_1=1,V2=2) {$f_2 $};
% Draw the edges
\draw[edge=red] (V2_1) -- node[edgeLabel] {$e_c'$} (V1_1);
\draw[edge=blue] (V1_1) -- node[edgeLabel] {$e_b'$} (V3_1);
\draw[edge=green] (V3_1) -- node[edgeLabel] {$e_a$} (V2_1);
\draw[edge=red] (V3_1) -- node[edgeLabel] {$e_c$} (V4_1);
\draw[edge=blue] (V2_1) -- node[edgeLabel] {$e_b$} (V4_1);
\draw[edge=blue] (V2_1) -- node[edgeLabel] {$e_1'$} (V1);
\draw[edge=green] (V4_1) -- node[edgeLabel] {$e_3$} (V2);
\draw[edge=blue] (V3_1) -- node[edgeLabel] {$e_1$} (V2);
\draw[edge=red] (V2_1) -- node[edgeLabel] {$e_2$} (V2);
\draw[edge=red] (V3_1) -- node[edgeLabel] {$e_2'$} (V1);
\draw[edge=green] (V1_1) -- node[edgeLabel] {$e_3'$} (V1);
% Draw the vertices
