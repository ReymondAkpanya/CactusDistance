...
\node[faceLabel] at (barycentric cs:V2_1=1,V3_1=1,V1_1=1) {$ F_2$};
\fill[face]  (V2_1) -- (V3_1) -- (V4_1) -- cycle;
\node[faceLabel] at (barycentric cs:V2_1=1,V3_1=1,V4_1=1) {$ F_1$};
...
%\draw[edge] (V2_1) -- node[edgeLabel] {$1$} (V1);
%\draw[edge] (V4_1) -- node[edgeLabel] {$1$} (V2);
%\draw[edge] (V3_1) -- node[edgeLabel] {$1$} (V2);
%\draw[edge] (V2_1) -- node[edgeLabel] {$1$} (V2);
%\draw[edge] (V3_1) -- node[edgeLabel] {$1$} (V1);
%\draw[edge] (V1_1) -- node[edgeLabel] {$1$} (V1);
% Draw the vertices
