...
% Draw the edges
\draw[edge] (V2_1) -- node[edgeLabel] {$e_c'$} (V1_1);
\draw[edge] (V1_1) -- node[edgeLabel] {$e_b'$} (V3_1);
\draw[edge] (V3_1) -- node[edgeLabel] {$e_a$} (V2_1);
\draw[edge] (V3_1) -- node[edgeLabel] {$e_c$} (V4_1);
\draw[edge] (V2_1) -- node[edgeLabel] {$e_b$} (V4_1);
\draw[edge] (V2_1) -- node[edgeLabel] {$e_1'$} (V1);
\draw[edge] (V4_1) -- node[edgeLabel] {$e_3$} (V2);
\draw[edge] (V3_1) -- node[edgeLabel] {$e_1$} (V2);
\draw[edge] (V2_1) -- node[edgeLabel] {$e_2$} (V2);
\draw[edge] (V3_1) -- node[edgeLabel] {$e_2'$} (V1);
\draw[edge] (V1_1) -- node[edgeLabel] {$e_3'$} (V1);
% Draw the vertices
