...
% Fill in the faces
\fill[face] (1.5,2) -- (1.5,-0.5) --(-1.5,-0.5) -- (-1.5,2) -- cycle;
...
\node[faceLabel] at (barycentric cs:V5_1=1,V7_1=1,V3_1=1) {$F_3$};
%\node[faceLabel] at (barycentric cs:V6_1=1,V3_1=1,V4_1=1) {$F_1$};

\node[faceLabel] at (barycentric cs:V5_2=1,V5_1=1,V1_1=1) {$F_2$};
...
\draw[edge] (V1_1) --  node[edgeLabel] {$e_3$}  (V3_1);
\draw[edge] (V3_1) --  node[edgeLabel] {$e_4$} (V2_1);
%\draw[edge] (V4_1) --   (V2_1);
%\draw[edge] (V3_1) --   (V4_1);
%\draw[edge] (V3_1) --   (V6_1);
%\draw[edge] (V6_1) --  (V4_1);
\draw[edge] (V3_1) -- node[edgeLabel] {$e_1$}   (V5_1);
\draw[edge] (V1_1) --  node[edgeLabel] {$e_6$}  (V5_1);
%\draw[edge] (V7_1) --  (V6_1);
\draw[edge] (V7_1) --  node[edgeLabel] {$e_5$} (V5_1);
\draw[edge] (V7_1) -- node[edgeLabel] {$e_4$}  (V3_1);
...
%\draw[edge] (V6_2) --   (V5_2);
%\draw[edge] (V6_2) --   (V2_2);
\draw[edge] (V5_2) --  node[edgeLabel] {$e_5$}  (V5_1);
\draw[edge] (V1_1) --   node[edgeLabel] {$e_2$} (V5_2);
